...
Lastly, it is important to note that the assumptions of a linear regression do not *all* map to logistic regression. The following two assumptions from linear regression **DO NOT APPLY** to logistic regression:
...
* `positive` - a character string indicating the 'positive' outcome (predicted as 1). If not specified, the confusion matrix assumes that the first specified category is the positive outcome.
